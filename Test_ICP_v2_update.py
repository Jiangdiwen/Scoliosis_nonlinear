...
def Test_Calc_SSMTsfm_2PtSets(Vy, SSM, deform_TH=0, PartialList=0, numPC=0, ind_PCs=0, Sz_Target=0,
    ...
    # the fitted points
    Vx0 = SSM['Verts_mean_Skin'] + np.dot(coef, SSM['Eigenvect_Skin'][ind_PCs, :])
